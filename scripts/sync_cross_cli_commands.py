...
COMMANDS: list[dict[str, str]] = [
    ...
    {"name": "jmty", "description": "ジモティー統合スキルを起動する", "kind": "skill", "skill_path": ".agent/skills/jmty/jmty-posts/SKILL.md"},
    {"name": "jmty-weekly", "description": "ジモティー統合スキルで週次素材処理を起動する", "kind": "skill", "skill_path": ".agent/skills/jmty/jmty-posts/SKILL.md"},
]
