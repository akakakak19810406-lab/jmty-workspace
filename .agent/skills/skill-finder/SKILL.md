...
| `no-python-post-writing` | 投稿文作成で Python固定テンプレートを使わず、AI生成と素材参照で作る必須ルール | `.agent/skills/jmty/no-python-post-writing/SKILL.md` |
...
| 在宅求人だけ作る | `jmty-posts` の `remote` と `no-python-post-writing` |
