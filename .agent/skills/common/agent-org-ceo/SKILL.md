...
| パターン | 流れ |
|---------|------|
| 投稿文作成 | CEO → Writing Manager |
| 素材確認付き投稿作成 | CEO → Research Manager → Writing Manager |
| Drive 同期 | CEO → Automation Manager |
| 画像整理 | CEO → Media Manager |
| Git / setup | CEO → Ops Manager |

## Writing Manager と Media Manager の境界
- 投稿文・見出し・本文 → Writing Manager
- 画像配置・週次素材処理 → Media Manager
- Google Drive 同期や定型実行 → Automation Manager
